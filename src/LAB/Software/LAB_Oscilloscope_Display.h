...
private:
  ...
  unsigned calc_graphing_area_width(double tpd_ds,
                                    unsigned display_width) const;
  double calc_x_coord_scaling(unsigned graphing_area_width,
                              unsigned number_of_samples) const;
  int calc_x_coord_start_offset(unsigned graphing_area_width,
                                unsigned display_width) const;
...
public:
  ...
  void display_parameters(unsigned width,
                          unsigned height,
                          unsigned rows,
                          unsigned columns);
