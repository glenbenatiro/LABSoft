...
LAB_Voltmeter::LAB_Voltmeter(LAB& _LAB)
  : LAB_Module(_LAB)
{
}

void
LAB_Voltmeter::load_oscilloscope_voltmeter_mode_settings()
{
...
bool
LAB_Voltmeter::is_frontend_running() const
{
  return (m_parent_data.is_frontend_running);
}

bool
LAB_Voltmeter::is_backend_running() const
{
...
void
LAB_Voltmeter::frontend_run_stop(bool value)
{
  m_parent_data.is_frontend_running = value;
}

void
LAB_Voltmeter::backend_run_stop(bool value)
{
...
double
LAB_Voltmeter::get_reading(unsigned chan)
{
