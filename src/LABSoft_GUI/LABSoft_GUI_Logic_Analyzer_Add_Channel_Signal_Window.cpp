...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::init_children_guis()
{
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::init_this_gui()
{
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::hide_as_modal()
{
  hide();
  clear_modal_states();
}
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::reset_state()
{
  m_name->value("");
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::cb_multi_browser(
  Fl_Multi_Browser* w,
  void* data)
{
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::cb_add(Fl_Button* w,
                                                             void* data)
{
  hide_as_modal();
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::cb_cancel(Fl_Button* w,
                                                                void* data)
{
  hide_as_modal();
}
...
void
cb_window_close(LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window* w,
                void* data)
{
}

void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::cb_multi_browser_static(
  Fl_Multi_Browser* w,
  void* data)
{
  (reinterpret_cast<LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window*>(
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::cb_add_static(
  Fl_Button* w,
  void* data)
{
  (reinterpret_cast<LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window*>(
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::cb_cancel_static(
  Fl_Button* w,
  void* data)
{
  (reinterpret_cast<LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window*>(
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::cb_window_close_static(
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::show_as_modal()
{
  set_modal();
  show();
}
...
void
LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window::number_of_channels(
  unsigned value)
{
  char label[20];
