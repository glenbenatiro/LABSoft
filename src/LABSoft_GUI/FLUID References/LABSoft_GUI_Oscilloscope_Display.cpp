  ...
  : LABSoft_GUI_Oscilloscope_Display(X, Y, W, H, L)
{
  ...
  } // Fl_Box* c2 vpd unit
  {
    ...
    c1 volts per div first->align(
      Fl_Align(FL_ALIGN_TOP_LEFT | FL_ALIGN_INSIDE));
  ...
  {
    Fl_Box* o = new Fl_Box(
      200, 0, 20, 20, "2000 samples at 200 kHz | 2023-08-15 13:03:41:231");
    o->color(FL_FOREGROUND_COLOR);
    o->labelsize(12);
    o->labelcolor(FL_BACKGROUND2_COLOR);
