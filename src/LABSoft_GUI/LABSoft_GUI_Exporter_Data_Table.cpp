...
LABSoft_GUI_Exporter_Data_Table::LABSoft_GUI_Exporter_Data_Table(
  int X,
  int Y,
  int W,
  int H,
...
void
LABSoft_GUI_Exporter_Data_Table::draw_cell(
  LABSoft_GUI_Exporter_Data_Table::TableContext context,
  int R,
  int C,
  int X,
  int Y,
