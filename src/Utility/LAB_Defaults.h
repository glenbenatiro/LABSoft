...
constexpr double CONVERSION_CONSTANT =
  CONVERSION_REFERENCE_VOLTAGE / ((LABC::OSC::ADC_RESOLUTION_INT - 1) >> 1);
// vertical
...
constexpr double MIN_OSC_HARDWARE_TRIGGER_LEVEL =
  -1 * CONVERSION_REFERENCE_VOLTAGE;

// calibration data
extern const std::unordered_map<LABE::OSC::SCALING, double>
...
constexpr double TIME_PER_DIVISION =
  SAMPLES / (SAMPLING_RATE * LABC::LOGAN::DISPLAY_NUMBER_OF_COLUMNS);
constexpr double HORIZONTAL_OFFSET = 0.0;

// mode
constexpr LABE::LOGAN::MODE MODE =
  (TIME_PER_DIVISION < LABC::LOGAN::MIN_TIME_PER_DIVISION_SCREEN)
    ? LABE::LOGAN::MODE::REPEATED
    : LABE::LOGAN::MODE::SCREEN;

// trigger
constexpr LABE::LOGAN::TRIG::CND TRIGGER_CONDITION =
  LABE::LOGAN::TRIG::CND::IGNORE;
