...
init_gui_values ()
{
  LAB_Function_Generator& gen = m_controller.lab ().m_Function_Generator;
             ...
             long             channel)
{
  if (w->value () == 0)
  {
    m_controller.lab ().m_Function_Generator.stop (channel);
  }
  else
  {
    m_controller.lab ().m_Function_Generator.run (channel);
  }
}
              ...
              long       channel)
{
  ...
  m_controller.lab ().m_Function_Generator.wave_type (channel, wave_type);
}
              ...
              long             channel)
{
  LABSoft_GUI_Label lbl (
    w->value (),
    m_controller.lab ().m_Function_Generator.amplitude (channel),
              ...
              long             channel)
{
  LABSoft_GUI_Label lbl (
    w->value (),
    m_controller.lab ().m_Function_Generator.frequency (channel),
           ...
           long             channel)
{
  LABSoft_GUI_Label lbl (
    w->value (),
    m_controller.lab ().m_Function_Generator.period (channel),
          ...
          long             channel)
{
  LABSoft_GUI_Label lbl (
    w->value (),
    m_controller.lab ().m_Function_Generator.phase (channel),
                    ...
                    long              channel)
{
  LABSoft_GUI_Label lbl (
    w->value (),
    m_controller.lab ().m_Function_Generator.vertical_offset (channel),
    LABSoft_GUI_Label::UNIT::VOLT
  );
