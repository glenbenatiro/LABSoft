...
constexpr double  LAB_OSCILLOSCOPE_MAX_SAMPLE_PERIOD      = (1.0 / LAB_OSCILLOSCOPE_MAX_SAMPLE_RATE);
constexpr int     LAB_OSCILLOSCOPE_ADC_CE                 = 0; // CE0 or CE1

constexpr double LABSOFT_OSC_DISP_MIN_REPEATED_SAMP_PERIOD = 1.0 / LABSOFT_OSCILLOSCOPE_DISPLAY_GROUP_NUMBER_OF_COLUMNS;
