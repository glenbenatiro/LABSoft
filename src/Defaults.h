...
// General LABSoft
constexpr double DISPLAY_UPDATE_RATE = (1.0 / 60.0); // in seconds, 25fps
...
constexpr int LAB_OSCILLOSCOPE_SAMPLE_RATE = 100'000; // default sample rate, in hz
...
constexpr double LABSOFT_OSCILLOSCOPE_DISPLAY_GROUP_VOLTS_PER_DIVISION = 1.0; // volts
