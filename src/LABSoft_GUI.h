...
private:
  inline void cb_oscilloscope_fl_input_choice_test_i(Fl_Input_Choice*, long);
  static void cb_oscilloscope_fl_input_choice_test(Fl_Input_Choice*, long);
...
private:
  inline void cb_logic_analyzer_fl_button_master_run_stop_i(Fl_Button*, void*);
  static void cb_logic_analyzer_fl_button_master_run_stop(Fl_Button*, void*);
public:
