...
LABSoft_Controller (LAB *_LAB, LABSoft_GUI *_LABSoft_GUI)
{
  ...
  m_Voltmeter          = new LABSoft_Controller_Voltmeter          (m_LAB, m_LABSoft_GUI);
  m_Ammeter            = new LABSoft_Controller_Ammeter            (m_LAB, m_LABSoft_GUI);
  m_Ohmmeter           = new LABSoft_Controller_Ohmmeter           (m_LAB, m_LABSoft_GUI);
  m_Function_Generator                    = new LABSoft_Controller_Function_Generator (m_LAB, m_LABSoft_GUI);
  m_LABSoft_Controller_Logic_Analyzer     = new LABSoft_Controller_Logic_Analyzer     (m_LAB, m_LABSoft_GUI);
  m_Power_Supply       = new LABSoft_Controller_Power_Supply       (m_LAB, m_LABSoft_GUI);
