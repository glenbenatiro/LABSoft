...
LABSoft_Presenter_Exporter::LABSoft_Presenter_Exporter(
...
void
LABSoft_Presenter_Exporter::show_window_as_modal()
{
...
void
LABSoft_Presenter_Exporter::hide_window_as_modal()
{
...
void
LABSoft_Presenter_Exporter::load_window_label()
{
  char label[50];

  std::snprintf(
    label, sizeof(label), "%s - Export", gui().main_fl_tabs->value()->label());

  gui().main_fl_window_exporter->label(label);
}

void
LABSoft_Presenter_Exporter::load_table_data()
{
  lab().m_Exporter.update_data_table();
}

void
LABSoft_Presenter_Exporter::load_image_data()
{
}

void
LABSoft_Presenter_Exporter::store_displayed_instrument()
{
...
void
LABSoft_Presenter_Exporter::update_data_display()
{
  ...
  if (label == "Data") {
    ...
    throw(
      std::runtime_error("LABSoft_Presenter_Exporter::update_data_display ()"));
  }
}

void
LABSoft_Presenter_Exporter::show_file_chooser_export_window()
{
...
void
LABSoft_Presenter_Exporter::cb_show_window()
{
...
void
LABSoft_Presenter_Exporter::cb_cancel()
{
  hide_window_as_modal();
}

void
LABSoft_Presenter_Exporter::cb_save()
{
  show_file_chooser_export_window();
}

void
LABSoft_Presenter_Exporter::cb_comments(Fl_Light_Button* w)
{
  lab().m_Exporter.comments(w->value());
}

void
LABSoft_Presenter_Exporter::cb_headers(Fl_Light_Button* w)
{
  lab().m_Exporter.headers(w->value());
}

void
LABSoft_Presenter_Exporter::cb_labels(Fl_Light_Button* w)
{
