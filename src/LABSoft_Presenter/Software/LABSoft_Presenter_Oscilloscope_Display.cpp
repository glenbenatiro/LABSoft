...
LABSoft_Presenter_Oscilloscope_Display::LABSoft_Presenter_Oscilloscope_Display(
...
LABSoft_Presenter_Oscilloscope_Display::load_gui()
{
  ...
  osc_disp.display_parameters(osc_disp_gui.display_width(),
...
void
LABSoft_Presenter_Oscilloscope_Display::cb_horizontal_offset(double value)
{
}

void
LABSoft_Presenter_Oscilloscope_Display::cb_mouse_wheel(int direction) const
{
}

void
LABSoft_Presenter_Oscilloscope_Display::update_display()
{
  LAB_Oscilloscope_Display& osc_disp = lab().m_Oscilloscope_Display;
  LABSoft_GUI_Oscilloscope_Display& osc_disp_gui =
    *(gui().oscilloscope_labsoft_gui_oscilloscope_display);
