    ...
    init_gui()
{
  ...
  LABSoft_GUI_LABChecker_Digital_Input_Table &table = *(m_presenter.gui().labchecker_digital_labsoft_gui_labchecker_digital_input_table);
    ...
    update_gui_digital_output_count(unsigned value)
{
  ...
  std::snprintf(c, sizeof(c), "Outputs (Max %d)", m_presenter.gui().labchecker_digital_labsoft_gui_labchecker_digital_input_table->max_output_count());
                          ...
                          void *data)
{
  ...
  m_presenter.gui().labchecker_digital_labsoft_gui_labchecker_digital_input_table->input_bits(bits);

  update_gui_digital_output_count(m_presenter.gui().labchecker_digital_labsoft_gui_labchecker_digital_input_table->output_count());
}
                           ...
                           void *data)
{
  ...
  m_presenter.gui().labchecker_digital_labsoft_gui_labchecker_digital_input_table->output_bits(bits);
}
                           ...
                           void *data)
{
  ...
  default:
  {
    LABSoft_GUI_LABChecker_Digital_Input_Table &table = *(gui().labchecker_digital_labsoft_gui_labchecker_digital_input_table);

    m_presenter.lab().m_LABChecker_Digital.create_circuit_checker_file(table.inputs(), table.outputs(), chooser.filename());
