...
public:
  ...
  void cb_voltage_per_division (LABSoft_GUI_Fl_Input_Choice_With_Scroll *w,
                                long channel);
  void cb_vertical_offset (LABSoft_GUI_Fl_Input_Choice_With_Scroll *w,
                           long channel);
  void cb_vertical_offset_slider (LABSoft_GUI_Fl_Slider *w, void *data);

  // horizontal
  void cb_horizontal_offset (LABSoft_GUI_Fl_Input_Choice_With_Scroll *w,
                             void *data) const;
  void cb_time_per_division (LABSoft_GUI_Fl_Input_Choice_With_Scroll *w,
                             void *data);
  ...
  void cb_trigger_level (LABSoft_GUI_Fl_Input_Choice_With_Scroll *w,
                         void *data);
