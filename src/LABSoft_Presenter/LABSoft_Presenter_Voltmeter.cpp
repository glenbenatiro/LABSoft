...
LABSoft_Presenter_Voltmeter::LABSoft_Presenter_Voltmeter(
...
void
LABSoft_Presenter_Voltmeter::init_gui_values()
{
...
void
LABSoft_Presenter_Voltmeter::run_gui()
{
  gui().voltmeter_fl_light_button_run_stop->set();
}

void
LABSoft_Presenter_Voltmeter::stop_gui()
{
  gui().voltmeter_fl_light_button_run_stop->clear();
}

void
LABSoft_Presenter_Voltmeter::cb_run_stop(Fl_Light_Button* w, void* data)
{
  if (w->value()) {
...
void
LABSoft_Presenter_Voltmeter::display_update_cycle()
{
  if (lab().m_Voltmeter.is_frontend_running()) {
    LABSoft_GUI_Label chan_0_dc(lab().m_Oscilloscope.measurements().avg(0),
                                LABSoft_GUI_Label::UNIT::VOLT);
    LABSoft_GUI_Label chan_0_min(lab().m_Oscilloscope.measurements().min(0),
                                 LABSoft_GUI_Label::UNIT::VOLT);
    LABSoft_GUI_Label chan_0_max(lab().m_Oscilloscope.measurements().max(0),
                                 LABSoft_GUI_Label::UNIT::VOLT);
    LABSoft_GUI_Label chan_0_trms(lab().m_Oscilloscope.measurements().trms(0),
                                  LABSoft_GUI_Label::UNIT::VOLT);

    LABSoft_GUI_Label chan_1_dc(lab().m_Oscilloscope.measurements().avg(1),
                                LABSoft_GUI_Label::UNIT::VOLT);
    LABSoft_GUI_Label chan_1_min(lab().m_Oscilloscope.measurements().min(1),
                                 LABSoft_GUI_Label::UNIT::VOLT);
    LABSoft_GUI_Label chan_1_max(lab().m_Oscilloscope.measurements().max(1),
                                 LABSoft_GUI_Label::UNIT::VOLT);
    LABSoft_GUI_Label chan_1_trms(lab().m_Oscilloscope.measurements().trms(1),
                                  LABSoft_GUI_Label::UNIT::VOLT);
