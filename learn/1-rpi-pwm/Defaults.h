...
constexpr float LABSOFT_OSCILLOSCOPE_DISPLAY_VOLTS_PER_DIVISION = 1.0;
...
constexpr int LABSOFT_OSCILLOSCOPE_DISPLAY_MAX_NUMBER_OF_CHANNELS = LAB_OSCILLOSCOPE_MAX_NUMBER_OF_CHANNELS;

#define LABSOFT_OSCILLOSCOPE_DISPLAY_FUNCTION_VOLTS_PER_DIVISION  1.0
#define LABSOFT_OSCILLOSCOPE_DISPLAY_TIME_PER_DIVISION

static int LABSOFT_OSCILLOSCOPE_DISPLAY_CHANNEL_GRAPH_COLORS
  [LABSOFT_OSCILLOSCOPE_DISPLAY_MAX_NUMBER_OF_CHANNELS] = 
{
  0x00000003,
  0x00000006,
  0x00000002,
